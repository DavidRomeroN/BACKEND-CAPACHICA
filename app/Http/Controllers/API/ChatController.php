...
class ChatController extends Controller
{
    ...
    public function enviarMensaje(Request $request, $reserva_id): JsonResponse
    {
        ...
        if ($emisor === 'emprendedor') {
            $emprendimientoIds = $reserva->servicios()->pluck('emprendedor_id')->filter()->unique();
            if ($emprendimientoIds->isEmpty() || !$user->emprendimientos()->whereIn('emprendedores.id', $emprendimientoIds)->exists()) {
