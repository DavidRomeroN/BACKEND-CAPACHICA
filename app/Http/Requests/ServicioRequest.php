...
class ServicioRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        $rules = [
            ...
            'eliminar_galeria' => 'sometimes|array',
            'eliminar_galeria.*' => 'string',
        ];
    ...
    public function messages(): array
    {
        return [
            ...
            'eliminar_imagen.boolean' => 'El valor de eliminar imagen debe ser verdadero o falso',
            'eliminar_galeria.array' => 'El listado de imágenes a eliminar debe ser un arreglo',
        ];
    }
}
